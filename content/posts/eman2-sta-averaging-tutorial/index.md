...
- Use the GUI directly: ![Manual boxing](manual-boxing.png#small)
...
![Main window - Manual boxing](manual-boxing-main-window.jpg#small)
...
![Particle Extraction](particle-extraction.jpg#small)
...
![Build sets](build-set.jpg#small)
...
![Generate initial model](generate-initial-model.jpg#small)
...
![New initial model generator](new-initial-model-generator.jpg#small)
...
![Reference-based Boxing](reference-based-boxing.jpg#small)
...
![Manual boxing](manual-boxing.jpg#small)
...
![Main window - Manual boxing](main-window-manual-boxing.jpg#small)
...
![Particle Extraction](particle-extraction-2.jpg#small)

Then use "Build Sets" to construct the particle set.

![Build Sets](build-set-2.jpg#small)
...
![3D Refinement](refinement-3d.jpg#small)

The result after running:

![3D Refinement Result](refinement-3d-result.png#small)
