...
![copying-machine](copying-machine.png)
...
![pinhole-camera](pinhole-camera.png#small)
...
![light-as-a-wave](light-as-a-wave.png#small)
...
![amplitude-intensity](amplitude-intensity.png#small)
...
![spherical-and-plane-wave](spherical-and-plane-wave.png#small)
...
![the-bending-of-light](the-bending-of-light.png#small)

This is the wave optic view of the effect of the microscope lenses:

![wave-optic-view](wave-optic-view.png#small)
...
![Youngs-two-slit-experiment](Youngs-two-slit-experiment.png#small)
...
![interference-of-light-from-two-wavelets](interference-of-light-from-two-wavelets.png#small)
...
![high-and-low-na](high-and-low-na.png#small)
...
![finest-fringes-determines-finest-details](finest-fringes-determines-finest-details.png#small)
...
![longer-shorter-wavelength](longer-shorter-wavelength.png#small)
...
![three-wavelets](three-wavelets.png#small)

<span class="caption">Effect of three wavelets[^5]</span>

![five-wavelets](five-wavelets.png#small)

<span class="caption">Effect of five wavelets[^5]</span>

![nine-wavelets](nine-wavelets.png#small)
